...
Strains.LIST = {
    { id = "actinia",   name = "Actinia",   tolerance = 70,  stingBase = 9, stingGain = 34,
      aiRate = 0.036, feedMul = 0.8, resist = 0.0,  pattern = Strains.PAT.actinia },   -- glass cannon
    { id = "metridium", name = "Metridium", tolerance = 155, stingBase = 6, stingGain = 13,
      aiRate = 0.022, feedMul = 1.5, resist = 0.0,  pattern = Strains.PAT.metridium }, -- economy tank
    { id = "urticina",  name = "Urticina",  tolerance = 140, stingBase = 7, stingGain = 21,
      aiRate = 0.024, feedMul = 1.0, resist = 0.10, pattern = Strains.PAT.urticina },  -- attrition
    { id = "aggressor", name = "Aggressor", tolerance = 150, stingBase = 8, stingGain = 28,
      aiRate = 0.034, feedMul = 1.1, resist = 0.35, pattern = Strains.PAT.aggressor, boss = true },
}
